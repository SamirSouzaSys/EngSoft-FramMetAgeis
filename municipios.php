...
<html lang="en">
  <head>
    ...
    <title>Small Site - Municípios</title>
  ...
  <div class="container py-3">
    <header class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-dark text-decoration-none" href="municipios.php"><strong>Municípios</strong></a>
        <a class="py-2 text-dark text-decoration-none" href="unidadesFederativas.php">Unidades Federativas</a>
      </nav>
    </header>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      ...
      <br/>
      <h3><strong>Municípios</strong></h3>
    </div>
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-4"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-6"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-7"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-8"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-9"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-10"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-11"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-12"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-13"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-14"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-15"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-16"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-17"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-18"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-19"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-20"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-21"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-22"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-23"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-24"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-25"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-26"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-27"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-28"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-29"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-30"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-31"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-32"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-33"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-34"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-35"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-36"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-37"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-38"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-39"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-40"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-41"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-42"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-43"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-44"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-45"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-46"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-47"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-48"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-49"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-50"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-51"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-52"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-53"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-54"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-55"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-56"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-57"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-58"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-59"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-60"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-61"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-62"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-63"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-64"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-65"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-66"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-67"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-68"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-69"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-70"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-71"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-72"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-73"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-74"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-75"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-76"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-77"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-78"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-79"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-80"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-81"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-82"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-83"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-84"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-85"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-86"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-87"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-88"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-89"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-90"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-91"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-92"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-93"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-94"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-95"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-96"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-97"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-98"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-99"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-100"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-101"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-102"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-103"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-104"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-105"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-106"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-107"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-108"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-109"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-110"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-111"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-112"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-113"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-114"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-115"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-116"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-117"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-118"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-119"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-120"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-121"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-122"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-123"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-124"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-125"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-126"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-127"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-128"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-129"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-130"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-131"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-132"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-133"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-134"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-135"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-136"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-137"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-138"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-139"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-140"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-141"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-142"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-143"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-144"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-145"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-146"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-147"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-148"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-149"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-150"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-151"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-152"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-153"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-154"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-155"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-156"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-157"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-158"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-159"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-160"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-161"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-162"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-163"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-164"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-165"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-166"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-167"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-168"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-169"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-170"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-171"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-172"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-173"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-174"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-175"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-176"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-177"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-178"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-179"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-180"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-181"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-182"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-183"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-184"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-185"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-186"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-187"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-188"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-189"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-190"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-191"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-192"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-193"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-194"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-195"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-196"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-197"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-198"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-199"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-200"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-201"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-202"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-203"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-204"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-205"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-206"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-207"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-208"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-209"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-210"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-211"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-212"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-213"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-214"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-215"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-216"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
...
<td>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEditForm">
<i class="fas fa-pen-square me-217"></i>
</button>
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDeleteForm">
 <i class="fas fa-times-circle"></i>
</button>  
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Número da população</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Nome do Prefeito</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form>
          <div class="modal-body">
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Alterar/Modificar a Sigla</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Alterar/Modificar o Nome</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Alterar/Modificar o Número da população</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Alterar/Modificar o Nome do Prefeito</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form>
          <div class="modal-body">
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Você tem certeza que desja excluir os dados do Município?</label>
            </div>
          </div>
          <div class="modal-footer">
